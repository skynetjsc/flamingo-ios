...
class ListNotificationController: BaseViewController, UITableViewDataSource, UITableViewDelegate {
...
//        cell.subTitle.attributedText = self.listNofitication[indexPath.row]["Content"] as? String
        do {
